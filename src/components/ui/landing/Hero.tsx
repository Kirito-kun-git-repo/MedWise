            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Meet <span className="font-semibold text-primary">MedWise</span> — your AI healthcare partner. 
                  Get instant answers to medical questions, check symptoms, book smart appointments, 
                  and receive personalized care guidance. Anytime. Anywhere.
                </p>
              </div>
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Trusted by{" "}
                      <span className="font-semibold text-foreground">2,000+ patients</span>
                    </p>
                  </div>
                </div>
              </div>
