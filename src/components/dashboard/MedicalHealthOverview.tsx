  ...
  return (
    <Card className="lg:col-span-2">
      <CardHeader>
        ...
        <CardDescription>Keep track of your medical care journey</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Book your first appointment or try our AI voice assistant for instant medical advice.
              </p>
