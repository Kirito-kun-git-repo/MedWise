      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Start for free, explore AI health insights, and upgrade for 24/7 medical guidance — all in one intelligent care assistant.
          </p>
        </div>
            ...
            <div className="relative bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground">Basic health chat & symptom checks</p>
                </div>
                ...
                <div className="space-y-4">
                  <Feature text="Instant AI health Q&A" />
                  <Feature text="Basic symptom checker" />
                  <Feature text="General wellness tips" />
                  <Feature text="Appointment reminders" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative bg-gradient-to-br from-card/95 to-card/70 backdrop-blur-xl rounded-3xl p-8 border-2 border-primary/30 hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-primary/20 scale-105">
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground">Personal AI medical guidance</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <Feature text="10 AI voice consultations per month" />
                  <Feature text="Personalized symptom analysis" />
                  <Feature text="Nutrition & lifestyle tracking" />
                  <Feature text="Priority AI support" />
                  <Feature text="Health record summary" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground">Unlimited health conversations</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <Feature text="Detailed health & symptom reports" />
                  <Feature text="Personalized wellness plans" />
                  <Feature text="24/7 AI medical assistant" />
                  <Feature text="Progress insights & tracking" />
                </div>
              </div>
            </div>
          </div>
