    ...
    <section className="relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-20">
        ...
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Our AI-powered process makes healthcare simpler, faster, and more accessible —
          connecting you with the right care when you need it most.
        </p>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-center">Describe Your Symptoms</h3>
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                Talk to our AI assistant about your symptoms or health concerns.
                Get quick insights, possible causes, and initial recommendations instantly.
              </p>
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-center">Receive AI Guidance</h3>
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                Our AI analyzes your inputs and provides possible conditions,
                self-care suggestions, and when to seek medical attention.
              </p>
          ...
          <div className="relative group">
            <div className="relative bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              ...
              <h3 className="text-2xl font-bold mb-4 text-center">Book Appointment & Follow Up</h3>
              <p className="text-muted-foreground text-center leading-relaxed mb-6">
                Connect with verified doctors for online or in-person consultations.
                Get reminders, prescriptions, and follow-up guidance directly in MedWise.
              </p>
